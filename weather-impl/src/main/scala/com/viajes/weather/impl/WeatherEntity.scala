...
/**
  * This is an event sourced entity. It has a state, [[WeatherState]], which
  ...
  */
class WeatherEntity extends PersistentEntity {

  override type Command = WeatherCommand[_]
  ...
  /**
    ...
    */
  override def initialState: WeatherState = WeatherState("Hello", LocalDateTime.now.toString)
  ...
  override def behavior: Behavior = {
    case WeatherState(message, _) => Actions().onCommand[UseGreetingMessage, Done] {
      ...
      case (GreetingMessageChanged(newMessage), state) =>
        ...
        // the event.
        WeatherState(newMessage, LocalDateTime.now().toString)
...
/**
  ...
  */
case class WeatherState(message: String, timestamp: String)
...
object WeatherState {
  /**
    ...
    */
  implicit val format: Format[WeatherState] = Json.format
}

/**
  * This interface defines all the events that the WeatherEntity supports.
  */
sealed trait WeatherEvent extends AggregateEvent[WeatherEvent] {
  def aggregateTag = WeatherEvent.Tag
}

object WeatherEvent {
  val Tag = AggregateEventTag[WeatherEvent]
}

/**
  * An event that represents a change in greeting message.
  */
case class GreetingMessageChanged(message: String) extends WeatherEvent
...
/**
  ...
  */
sealed trait WeatherCommand[R] extends ReplyType[R]
...
/**
  ...
  */
case class UseGreetingMessage(message: String) extends WeatherCommand[Done]
...
/**
  ...
  * person.
  */
case class Hello(name: String) extends WeatherCommand[String]
...
/**
  ...
  * application loader.
  */
object WeatherSerializerRegistry extends JsonSerializerRegistry {
  override def serializers: Seq[JsonSerializer[_]] = Seq(
    JsonSerializer[UseGreetingMessage],
    JsonSerializer[Hello],
    JsonSerializer[GreetingMessageChanged],
    JsonSerializer[WeatherState]
  )
}
